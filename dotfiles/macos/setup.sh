...
# Set computer name
sudo scutil --set ComputerName cah6
sudo scutil --set LocalHostName cah6
sudo scutil --set HostName cah6
...
# TODO: Doesn't work, it seems
# rm -rf ~/Library/Application Support/Dock/desktoppicture.db
# rm -rf /System/Library/CoreServices/DefaultDesktop.jpg
# ln -s mountain.jpg /System/Library/CoreServices/DefaultDesktop.jpg
osascript -e 'tell application "System Events" to tell every desktop to set picture to "~/dotfiles/macos/mountain.jpg"'
